...
`, this.el);
  ...
  render() {
    ...
    })) }, h("div", { key: "3753ff3dde3085070916c3de83687a219a49e553", class: "intersection-tracker", ref: (el2) => this.intersectionTrackerRef = el2 }), this.renderDatetime(mode));
  }
  get el() {
...
var PickerColumnCmp = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./index-CfgBF1SE-RDLII5KQ.js")).createGesture({
        el: this.el,
...
//# sourceMappingURL=ion-datetime_3.entry-II6ZOZBZ.js.map
